...
# Make the translator_agent an asynchronous function
async def translator_agent(state: AgentState) -> dict:
    """
    ...
    try:
        ...
        for i in range(0, len(full_content_to_translate), chunk_size):
            ...
            # Await the asynchronous translate call
            translated_obj = await translator.translate(chunk, dest=target_lang)
